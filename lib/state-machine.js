...
//for specific info to transferred between states, 
...
class State {
    ...
    exit() {
        //exit isn't used much at all but kept here to help readers understand 
        //the possible amount of refinement of state machines
    }
}